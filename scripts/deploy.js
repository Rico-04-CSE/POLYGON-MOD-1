...
// Asynchronous main function to deploy the Clover contract
async function main() {
  // Get the contract factory (ABI and bytecode) using the contract name "Clover"
  const NFT = await hre.ethers.getContractFactory("Clover");
